  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-green/10">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
        <div>
          <img className="h-16" src={assets.logo} alt="FreshlyPicked logo" />

          <p className="max-w-[410px] mt-6">
            FreshlyPicked is your shortcut to stress-free groceries. We do the
            picking, packing, and delivering — you just chill and unpack the
            freshness.
          </p>
        </div>
      ...
      <p className="py-4 text-center text-sm md:text-base text-gray-500/80">
        Copyright {new Date().getFullYear()} © FreshlyPicked All Right Reserved.
      </p>
    </div>
  );
};
